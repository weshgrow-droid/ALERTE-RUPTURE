...
const APP_VERSION = 'v2026-09-11-16h20-rupturesinsemis';
...
let STATE = {
  ...
  settings: { tendanceWeeksLong: 4, margeSecurite: 10 }, // réglages généraux persistés
...
async function loadPersistedState(){
  try{
    ...
    STATE.settings = parsed.settings || { tendanceWeeksLong: 4, margeSecurite: 10 };
    ...
    STATE.settings = { tendanceWeeksLong: 4, margeSecurite: 10 };
    STATE.semisFinal = {};
...
function renderRecommandationsTab(){
  ...
  for (const sec of sectionsToShow){
    ...
    for (const key of keys){
      ...
      const suggestion = roundToPlaque(wf.forecast * (1 + marge));
