...
const APP_VERSION = 'v2026-09-11-11h30-scaliasmerge';
...
let STATE = {
  ...
  settings: { tendanceWeeksLong: 4 }, // réglages généraux persistés (fenêtre de tendance longue, en semaines)
...
async function loadPersistedState(){
  try{
    ...
    STATE.settings = parsed.settings || { tendanceWeeksLong: 4 };
  }catch(e){
    console.error(e);
    STATE.ethOffsets = {};
    STATE.stockOverrides = {};
    STATE.weeklyDemandCorrections = {};
    STATE.settings = { tendanceWeeksLong: 4 };
...
async function savePersistedState(silent){
  try{
    await sheetsUpdateValues(APP_STATE_CONFIG.spreadsheetId, `'${APP_STATE_CONFIG.sheetTitle}'!A2:B2`,
      [['appState', JSON.stringify({ ethOffsets: STATE.ethOffsets, stockOverrides: STATE.stockOverrides, weeklyDemandCorrections: STATE.weeklyDemandCorrections, settings: STATE.settings })]]);
