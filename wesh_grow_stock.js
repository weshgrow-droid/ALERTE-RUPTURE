...
const APP_VERSION = 'v2026-09-10-13h00-noignoreflag';
...
function computeWeeklyForecast(v, weekStart, refWeekStart){
  // Tendance : moyenne simple des TENDANCE_WEEKS dernières semaines
  // complètes (poids égal). Une version pondérée (semaines récentes plus
  // lourdes) a été testée mais réagissait trop fort à une semaine isolée
  // anormalement basse/haute — retour à la moyenne simple, plus stable.
  let sum = 0;
