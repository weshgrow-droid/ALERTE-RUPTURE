...
const APP_VERSION = 'v2026-09-11-12h00-recommandations';
...
function renderRecommandationsTab(){
  ...
  for (const sec of sectionsToShow){
    ...
    for (const key of keys){
      ...
      const { momentum, confidence } = computeMomentum(v, targetWeekStart, weekStart);
      const suggestion = roundToPlaque(moyUnitesSem * momentum * (1 + marge));
