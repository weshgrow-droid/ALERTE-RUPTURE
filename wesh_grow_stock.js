...
const APP_VERSION = 'v2026-09-10-11h15-diagnostic';
...
function normalizeToBase(rawCode){
  ...
  const tryMatch = (c) => {
    ...
    if (STATE.productNames.has(c)) return { key: c, nom: STATE.productNames.get(c), unmapped: false, secteurMaj: STATE.productSecteurs.get(c) || null };
    return null;
  };
  ...
  return { key: fallback, nom: fallback, unmapped: true, secteurMaj: null };
}
